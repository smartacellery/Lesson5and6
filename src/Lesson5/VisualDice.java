...
public class VisualDice extends javax.swing.JFrame {
    ...
    public VisualDice() {
        initComponents();
        d1 = new Dice(jPanel1.getGraphics(), jPanel1.getWidth());
        d2 = new Dice(jPanel2.getGraphics(), jPanel2.getWidth());
        d3 = new Dice(jPanel3.getGraphics(), jPanel3.getWidth());
    }
